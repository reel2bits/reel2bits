...
def upgrade():
    op.create_table(
        ...
        sa.Column("outbox_url", sqlalchemy_utils.types.url.URLType(), nullable=True),
        ...
        sa.Column("preferred_username", sa.String(length=200), nullable=True),
        ...
        sa.Column("manually_approves_followers", sa.Boolean(), nullable=True),
