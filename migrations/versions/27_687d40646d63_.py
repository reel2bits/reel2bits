...
def upgrade():
    print("This migration may fails if you don't already have the "
          "extension created")
    print("If you get an error about 'function uuid_generate_v4() "
          "does not exist'")
    print("please run 'CREATE EXTENSION IF NOT EXISTS \"uuid-ossp\";' "
