        ...
        <div class="align-self-center">
          ...
          <div v-if="isOtherUser && loggedIn">
            ...
            >
              <template v-if="followRequestInProgress">
                <translate translate-context="Content/UserCardList/Button/Follow/in progress">
                  Follow in progress
                </translate>
              </template>
              <template v-else-if="followRequestSent">
                <translate translate-context="Content/UserCardList/Button/Follow/sent">
                  Follow sent
                </translate>
              </template>
              <template v-else>
                <translate translate-context="Content/UserCardList/Button/Follow">
                  Follow
                </translate>
              </template>
            </b-button>
            ...
            >
              <translate translate-context="Content/UserCardList/Button/Follow/change in progress">
                Change in progress
              </translate>
            </b-button>
            ...
            >
              <translate translate-context="Content/UserCardList/Button/Unfollow">
                Unfollow
              </translate>
            </b-button>
          </div>
          <p class="text-muted m-0">
            <template v-if="user.follows_you && loggedIn && isOtherUser">
              <translate translate-context="Content/UserCardList/Text/Follows you">
                Follows you
              </translate>
            </template>
          </p>
        ...
        <li class="nav-item border-right">
          <router-link :to="{ name: 'user-profile-tracks', params: { name: user.screen_name } }">
            <p class="h3 font-weight-normal m-0">
              ...
              <translate translate-context="Content/UserCardList/Text/Tracks (number of)">
                Tracks
              </translate>
            </p>
          </router-link>
        ...
        <li class="nav-item border-right">
          <router-link :to="{ name: 'user-profile-albums', params: { name: user.screen_name } }">
            <p class="h3 font-weight-normal m-0">
              ...
              <translate translate-context="Content/UserCardList/Text/Albums (number of)">
                Albums
              </translate>
            </p>
          </router-link>
        ...
        <li class="nav-item border-right">
          <router-link :to="{ name: 'user-profile-followers', params: { name: user.screen_name } }">
            <p class="h3 font-weight-normal m-0">
              ...
              <translate translate-context="Content/UserCardList/Text/Followers (number of)">
                Followers
              </translate>
            </p>
          </router-link>
        ...
        <li class="nav-item">
          <router-link :to="{ name: 'user-profile-followings', params: { name: user.screen_name } }">
            <p class="h3 font-weight-normal m-0">
              ...
              <translate translate-context="Content/UserCardList/Text/Following (number of)">
                Following
              </translate>
            </p>
          </router-link>
